...
class VideoRender(Thread):
    ...
    def _create_midi(self):
        ...
        """
        sheet_music_file = converter.parse(f"{self.file_name}{self.file_ext}")
    ...
    def render(self):
        ...
        audio = AudioFileClip(f"{self.output_file}.wav")
...
if __name__ == "__main__":
    VideoRender(
        "raw_89302b32-ccab-4f10-8e32-2a6eb4952465_chunk_0.xml", "raw_chunk.mp4"
    ).render()
